...
export default function AtorGrid({ category = "Ator", limit = 8 }) {
    ...
    async function load() {
      ...
      try {
        ...
        const res = await fetch(
          `/api/products/categories/ator?${q.toString()}`
        );
  ...
  if (loading)
    return (
      <div className="mt-6 md:mt-10 max-w-6xl mx-auto my-5 px-4 sm:px-6 lg:px-8">
        ...
        {/* Grid Skeleton matching the real grid layout */}
